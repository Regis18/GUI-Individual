...
#
  Scenario: Delete a account in Pivotal Tracker
    ...
    Then I should see a yellow message "New Account was successfully deleted." in the Accounts Page
...
#      |apitestingautomation|api.testing.automation@gmail.com|Owner|
  ...
  Scenario Outline: Delete member of an account Pivotal Tracker
    ...
    Then I should see a yellow message "'<nameMember>' has been removed from your account"
